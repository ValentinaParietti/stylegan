...
def main():
    ...
    draw_style_mixing_figure(os.path.join(config.result_dir, 'figure03-style-mixing.png'), load_Gs(url_mine), w=256, h=256, src_seeds=[3,7,11,30], dst_seeds=[40,41], style_ranges=[range(0,4)]*3+[range(4,8)]*2+[range(8,14)])
