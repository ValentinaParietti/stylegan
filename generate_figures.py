...
def main():
    ...
    draw_style_mixing_figure(os.path.join(config.result_dir, 'figure01-style-mixing.png'), load_Gs(url_mine), w=512, h=384, src_seeds=[10,3,85,200], dst_seeds=[144,39,70], style_ranges=[range(0,4)]*3+[range(4,8)]*2+[range(8,14)])
