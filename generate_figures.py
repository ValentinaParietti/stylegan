...
def main():
    ...
    draw_style_mixing_figure(os.path.join(config.result_dir, 'figure01-style-mixing.png'), load_Gs(url_mine), w=256, h=256, src_seeds=[1,3,85], dst_seeds=[144,39], style_ranges=[range(0,4)]*3+[range(4,8)]*2+[range(8,14)])
