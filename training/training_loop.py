...
def training_loop(
    ...
    resume_run_id           = '/results/00001-sgan-custom_datasets-1gpu/network-snapshot-003445.pkl',     # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 3445,      # Assumed training progress at the beginning. Affects reporting and training schedule.
