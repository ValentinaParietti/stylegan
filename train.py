...
if 1:
    ...
    # Dataset.
    desc += '-custom_datasets'; dataset = EasyDict(tfrecord_dir=r'custom_datasets', resolution=256); train.mirror_augment = False
    ...
    sched.G_lrate_dict = {128: 0.0015, 256: 0.0002, 512: 0.0003, 1024: 0.003}
